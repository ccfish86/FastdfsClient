...
public class UploadBufferFileCmd extends AbstractCmd<String> {
     ...
     */
	public UploadBufferFileCmd(BufferFile file,String extName,byte storePathIndex){
		super();
		this.file = file;
		...
		byte[] fileSizeByte = long2buff(file.getFiledata().length);
